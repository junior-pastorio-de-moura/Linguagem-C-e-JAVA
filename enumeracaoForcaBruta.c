...
//Função para verificação de restrições em folhas
int solucao(int v[], int i){
    return (v[1] != v[0]);
}

//Função de enumeração por força bruta
void enumeref(int n, char *map[], int *dom[], int m){
